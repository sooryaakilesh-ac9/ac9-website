      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="/#careers" className="text-gray-600 hover:text-yellow-500 transition-colors duration-200 font-medium">
              Careers
            </a>
            <Link to="/blog" className="text-gray-600 hover:text-yellow-500 transition-colors duration-200 font-medium">
              Blog
            </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 right-0 bg-white border-b border-gray-100 shadow-lg">
            <div className="px-4 py-4 space-y-4">
              ...
              <a href="/#careers" className="block text-gray-600 hover:text-yellow-500 transition-colors duration-200 font-medium">
                Careers
              </a>
              <Link to="/blog" className="block text-gray-600 hover:text-yellow-500 transition-colors duration-200 font-medium">
                Blog
              </Link>
