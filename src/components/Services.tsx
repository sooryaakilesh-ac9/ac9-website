      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="w-16 h-16 bg-yellow-100 text-yellow-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-200">
              ...
              <button className="w-full bg-white/50 hover:bg-yellow-500 border border-white/40 hover:border-yellow-400 text-gray-700 hover:text-white py-3 px-4 rounded-xl font-semibold transition-all duration-200">
                Learn More
              </button>
            </div>
          ))}
        ...
        <div className="text-center mt-16">
          <button className="bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 hover:scale-105">
            Get Custom Quote
          </button>
        </div>
      </div>
