      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="group bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 hover:scale-105 flex items-center">
              Start Your Journey
              <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" />
            </button>
            
            <button className="border-2 border-gray-400/50 hover:border-yellow-500 bg-white/30 text-gray-700 hover:text-yellow-600 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 hover:scale-105">
              Watch Demo
            </button>
          </div>
          ...
          <div className="mt-20">
            <div className="relative">
              <div className="bg-white/40 backdrop-blur-sm shadow-xl p-8 max-w-4xl mx-auto border border-white/50 rounded-2xl">
